...
**OpenClassrooms - Développeur d'application Python - Projet #6: Développez une interface utilisateur pour une application web Python**
...
- `git clone https://github.com/munchou/OpenClassrooms-Project-6.git`
...
Si vous ne voyez rien, c'est que la connection à l'API a échoué.